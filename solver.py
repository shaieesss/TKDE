...
class Solver(object):
    ...
    def build_model(self):
        self.model = DCdetector(win_size=self.win_size, enc_in=self.input_c, c_out=self.output_c, conv_channels=self.conv_channels, layer_num=self.layer_num)
    ...
    def test(self):
        ...
        # len(attens_energy)):5 attens_energy[i]: (256, 60)
